...
const CustomPluginInstallModal = memo<CustomPluginInstallModalProps>(
  ({ installRequest, isMarketplace = false, onComplete }) => {
    ...
    const handleConfirm = useCallback(async () => {
      ...
      setLoading(true);
      try {
        // Build custom plugin data for third-party marketplace and custom plugins
        ...
        // Test connection first to get real manifest for custom plugins
        ...
        // Use the real manifest obtained from test connection
        customPlugin = {
          customParams: {
            avatar: schema.icon,
            description: schema.description,
          ...
          manifest: testResult.manifest, // Use real manifest
          type: 'customPlugin',
        };
