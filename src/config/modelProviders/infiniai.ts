...
const InfiniAI: ModelProviderCard = {
  ...
  checkModel: 'qwen3-8b',
  description:
    'Provides application developers with high-performance, easy-to-use, secure, and reliable large model services, covering the entire process from large model development to service deployment.',
  id: 'infiniai',
