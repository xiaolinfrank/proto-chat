...
export class CreditService {
     ...
     * User prices are pre-calculated (cost price × multiplier) and used directly without runtime calculation for better performance.
     *
    ...
    async calculateCost(
        ...
        // Use pre-calculated user prices directly without runtime calculation (performance optimization)
