...
export const klavisRouter = router({
  ...
  createServerInstance: klavisProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      const isAuthenticated = !oauthUrl; // If there is no oauthUrl, authentication is not required or already completed
  ...
  deleteServerInstance: klavisProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      // Call the Klavis API to delete the server instance
