...
/**
 * Use this method to be compatible with cases that don't require login authentication
 */
const isLogin = (s: UserStore) => {
  // If authentication is not enabled, login is not required, default is logged in state
