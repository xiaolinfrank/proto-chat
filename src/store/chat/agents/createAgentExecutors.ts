  ...
  const executors: Partial<Record<AgentInstruction['type'], InstructionExecutor>> = {
    ...
    call_llm: async (instruction, state) => {
      ...
      if (shouldSkipCreateMessage) {
        // Skip the first creation, no longer skip afterwards
        ...
        // If this is the first regenerated creation of a userMessage, llmPayload doesn't have parentMessageId
        // Therefore assign it this way
        // TODO: Perhaps this should be implemented using an init method in the future
