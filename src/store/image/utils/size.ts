/**
 * Parses a ratio string, e.g. "16:9" -> 1.777
 * @param ratio - A ratio string in "width:height" format
 * @returns The ratio value, returns 1:1 ratio on error
 */
...
/**
 * Calculates the most suitable size based on the target ratio and default dimensions
 * @param ratio - The target aspect ratio
 * @param defaultWidth - The default width
 * @param defaultHeight - The default height
 * @returns The calculated size object
 */
