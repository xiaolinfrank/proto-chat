...
export function useDimensionControl() {
  ...
  const aspectRatioOptions = useMemo(() => {
    ...
    // If the schema has aspectRatio and it's not empty, use the schema options directly
  ...
  // Show the container as long as not all dimension-related controls are hidden
