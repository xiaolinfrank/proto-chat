...
export function useDimensionControl() {
  ...
  const aspectRatioOptions = useMemo(() => {
    ...
    // If schema has aspectRatio and is not empty, use options from schema directly
  ...
  // As long as not all dimension-related controls are hidden, this container should be shown
