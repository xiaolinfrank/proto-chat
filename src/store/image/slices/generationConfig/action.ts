  ...
  toggleAspectRatioLock: () => {
    set(
      (state) => {
        ...
        // If transitioning from unlocked to locked and there is an active aspect ratio, adjust dimensions immediately
          ...
          if (
            ...
            if (Math.abs(currentRatio - targetRatio) > 0.01) {
              ...
              if (
                ...
                // If the calculated height is out of range, keep height and adjust width instead
