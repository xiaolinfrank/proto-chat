...
export const defaultClients: ClientMetadata[] = [
  {
    ...
    post_logout_redirect_uris: [
      // Dynamically build the Web page callback URL
    ...
    // Supports obtaining tokens and refresh tokens via authorization code
    response_types: ['code'],

    // Marked as a public client, no secret
    token_endpoint_auth_method: 'none',
  },

  {
    application_type: 'native', // Use native type for mobile
    ...
    // Mobile does not need post_logout_redirect_uris since logout is typically handled in-app
    post_logout_redirect_uris: [],
    // Mobile uses a custom URL scheme
...
export const defaultScopes = [
  ...
  'profile',
  'email',
  'offline_access', // Allows obtaining a refresh_token
];
