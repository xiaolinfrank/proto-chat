 ...
 * @param resolvePromise Resolution function called when the response is complete
 */
...
export const createContextForInteractionDetails = async (
  ...
  // if issues arise, they may need to be extracted from real request headers (e.g., 'x-forwarded-for', 'user-agent')
  ...
  // pathPrefix is set to '/' because our URL is already in the Provider's expected path format /interaction/:uid
