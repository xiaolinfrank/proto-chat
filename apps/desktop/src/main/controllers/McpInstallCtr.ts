 ...
 * Responsible for handling the MCP plugin installation process
 */
export default class McpInstallController extends ControllerModule {
  ...
  public async handleInstallRequest(parsedData: McpInstallParams): Promise<boolean> {
    try {
      ...
      // For the official market, schema is optional; for third-party markets, schema is required
      ...
      // Broadcast installation request to the frontend
