...
export default class McpInstallController extends ControllerModule {
  ...
  public async handleInstallRequest(parsedData: McpInstallParams): Promise<boolean> {
    try {
      ...
      // For the official marketplace, schema is optional; for third-party marketplaces, schema is required
      ...
      if (schemaParam) {
        ...
        // Validate that the identifier matches the id parameter
      ...
      // Broadcast the install request to the frontend
