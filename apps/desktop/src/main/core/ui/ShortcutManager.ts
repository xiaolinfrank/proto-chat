...
export class ShortcutManager {
  ...
  updateShortcutConfig(id: string, accelerator: string): ShortcutUpdateResult {
    try {
      ...
      // 3. Check if it contains a + sign (modifier key format)
      ...
      // 4. Check if there are basic modifier keys
      ...
      // 6. Try registering for testing (check if occupied by system)
      ...
      if (!testSuccess) {
        ...
        // Test successful, unregister immediately
