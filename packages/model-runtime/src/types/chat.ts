...
export interface ChatStreamPayload {
  ...
  /**
   * @title Penalty coefficient for controlling repetition in generated text
   * @default 0
   */
  ...
  n?: number;
  /**
   * @title Penalty coefficient for controlling topic variation in generated text
   * @default 0
   */
  ...
  /**
   * @title Controls the single token with the highest probability in generated text
   * @default 1
   */
  top_p?: number;
  truncation?: 'auto' | 'disabled';
  /**
   * @title Gemini URL context fetch tool switch
   */
  urlContext?: boolean;
  verbosity?: 'low' | 'medium' | 'high';
}
