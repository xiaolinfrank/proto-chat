...
export const DEFAULT_EMBEDDING_MODEL = 'qwen-embed-4b';  // 32k context, affordable price
export const DEFAULT_EMBEDDING_PROVIDER = 'protochat';  // ProtoChat will route to OpenRouter

// Rerank feature is not yet implemented, configuration is only a placeholder
