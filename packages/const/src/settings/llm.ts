...
// Change to your actual model and provider in use
export const DEFAULT_MODEL = 'gemini-2.5-flash';  // ProtoChat will auto-route to gemini-2.5-flash
...
// Rerank feature is not currently implemented, configuration serves as placeholder
