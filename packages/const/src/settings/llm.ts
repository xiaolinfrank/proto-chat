...
// Use OpenRouter's Qwen Embedding (through ProtoChat)
// Option 1: Use ProtoChat's internal ID (requires backend configuration mapping)
...
// Rerank feature is not currently implemented, configuration serves as a placeholder
// If you need to enable it, you can configure Cohere or other providers that support rerank
