 ...
 * Stores API configuration for underlying providers like OpenRouter, DeepSeek, etc.
 */
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Provider alias, used for generating model IDs to hide real provider names
    // Format: a1, b2, c3, used in model IDs as: protochat::{alias}::{modelId}
    ...
    // Pricing synchronization configuration
 ...
 * Stores available models for ProtoChat provider and their mapping to underlying providers
 */
export const protochatModels = pgTable(
  'protochat_models',
  {
    ...
    // Backend enabled status (controls user visibility)
...
export const protochatModelPricing = pgTable(
  'protochat_model_pricing',
  {
    ...
    // Associated protochat_models.id
    ...
    // Price source: 'api', 'model_bank', 'manual'
 ...
 * Stores global configurations like pricing multipliers
 */
 ...
 * Records detailed logs of user usage of ProtoChat models for analysis and auditing
 */
