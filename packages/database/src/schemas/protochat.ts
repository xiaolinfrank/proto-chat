 ...
 * Stores API configuration for underlying providers such as OpenRouter, DeepSeek
 */
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Provider alias, used for generating model IDs while hiding the real provider name
