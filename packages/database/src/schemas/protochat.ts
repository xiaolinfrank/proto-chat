...
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Format such as a1, b2, c3, used in model IDs: protochat::{alias}::{modelId}
 ...
 * Records detailed usage logs for users using ProtoChat models, for analysis and auditing
 */
