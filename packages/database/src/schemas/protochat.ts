...
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Provider alias, used to generate model IDs and hide real provider names
    ...
    // Other settings (JSON format, extensible)
 ...
 * Stores global configurations such as pricing multiplier
 */
