...
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Provider alias, used for generating model IDs and hiding the real provider name
    // Format: a1, b2, c3, used in model ID as: protochat::{alias}::{modelId}
 ...
 * Stores available models for ProtoChat providers and their mappings to underlying providers
 */
 ...
 * Stores global configuration including pricing multipliers
 */
