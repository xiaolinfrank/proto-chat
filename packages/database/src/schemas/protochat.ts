...
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Priority for sorting when selecting providers
    priority: integer('priority').default(0),

    // Provider alias for generating model IDs and hiding real provider names
    // Format like a1, b2, c3, used in model IDs: protochat::{alias}::{modelId}
 ...
 * Stores available models from ProtoChat providers and their mapping to underlying providers
 */
 ...
 * Records detailed logs of users using ProtoChat models for analysis and auditing
 */
