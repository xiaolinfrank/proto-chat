 ...
 * Stores API configuration for underlying providers such as OpenRouter, DeepSeek, etc.
 */
 ...
 * Stores the models available to ProtoChat and their mapping to underlying providers
 */
