 ...
 * Stores API configurations for underlying providers like OpenRouter, DeepSeek, etc.
 */
 ...
 * Stores models available to the ProtoChat provider and their mappings to underlying providers
 */
 ...
 * Records detailed logs of user ProtoChat model usage for analytics and auditing
 */
