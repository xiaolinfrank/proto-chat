 ...
 * Stores API configuration for underlying providers such as OpenRouter and DeepSeek
 */
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Provider alias, used to generate model IDs and hide the real provider name
 ...
 * Stores models available for ProtoChat providers and their mapping to underlying providers
 */
...
export const protochatSettings = pgTable('protochat_settings', {
  // Settings item ID, e.g. 'pricing_multiplier'
