...
export const protochatModelPricing = pgTable(
  'protochat_model_pricing',
  {
    ...
    // Cost price (credits/million tokens)
    ...
    // User price (credits/million tokens) = cost price × pricing multiplier
 ...
 * Stores global configuration such as pricing multiplier
 */
