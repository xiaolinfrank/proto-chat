...
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Format e.g. a1, b2, c3, used in model ID as: protochat::{alias}::{modelId}
 ...
 * Stores models available to the ProtoChat provider and their mapping to underlying providers
 */
export const protochatModels = pgTable(
  'protochat_models',
  {
    ...
    // Whether enabled in admin (controls user visibility)
 ...
 * Detailed logs of user usage of ProtoChat models, used for analytics and auditing
 */
