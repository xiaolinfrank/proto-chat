...
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Provider alias, used for generating model IDs, hides the real provider name
    ...
    // Additional configuration (JSON format, extensible)
 ...
 * Stores the available models for the ProtoChat provider and their mapping to underlying providers
 */
 ...
 * Stores global configuration such as pricing coefficients
 */
