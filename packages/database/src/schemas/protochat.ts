...
export const protochatProviders = pgTable(
  'protochat_providers',
  {
    ...
    // Provider alias, used to generate model ID and hide the real provider name
 ...
 * Stores available models from ProtoChat provider and their mapping relationships with underlying providers
 */
