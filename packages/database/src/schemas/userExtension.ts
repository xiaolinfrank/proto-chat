...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Subscription type: 'recurring' (auto-renewing) | 'onetime' (one-time payment)
        ...
        // Preset plan ID for the next billing cycle (used for mid-cycle downgrade or subscription cancellation)
        ...
        // Downgrade reason: deduct_failed (payment failed), user_unsign (user cancelled), expired (not renewed upon expiry)
