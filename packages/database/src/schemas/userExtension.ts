...
// User extension table - manages subscription info and extended fields
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // References users.id in main project user table
        ...
        // ============ Downgrade info ============
        // Downgrade reason: deduct_failed (payment failed), user_unsign (user cancelled), expired (renewal lapsed)
