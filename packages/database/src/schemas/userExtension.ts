...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // References the main project user table users.id
        ...
        // Preset plan ID for the next billing cycle (used for mid-cycle downgrades or cancellations)
        ...
        // Downgrade reason: deduct_failed (deduction failed), user_unsign (user cancelled), expired (subscription expired)
