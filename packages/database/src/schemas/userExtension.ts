...
// User extension table for the main project - manages subscription info and extension fields
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // ============ Downgrade Info ============
        // Downgrade reason: deduct_failed (payment failure), user_unsign (user cancellation), expired (expired without renewal)
