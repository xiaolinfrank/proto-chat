...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Associated with the main project users table: users.id
        ...
        // ============ Downgrade Info ============
        // Downgrade reason: deduct_failed (deduction failed), user_unsign (user cancelled agreement), expired (expired without renewal)
