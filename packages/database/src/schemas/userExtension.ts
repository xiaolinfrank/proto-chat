...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Current billing cycle: 'month' | 'year', NULL for free users
        ...
        // Preset plan ID for the next billing cycle (used for mid-term downgrade or subscription cancellation)
        ...
        // Downgrade reason: deduct_failed (deduction failed), user_unsign (user unsign), expired (expired without renewal)
...
export const userSubscriptionHistory = pgTable('user_subscription_history', {
    ...
    // Associated main project user ID
