...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Duration months for one-time payment (1, 3, 6, 12), NULL for recurring subscription
        ...
        // Preset plan ID for next billing cycle (for mid-cycle downgrade or subscription cancellation)
        ...
        // Downgrade reason: deduct_failed (deduction failed), user_unsign (user canceled), expired (expired without renewal)
