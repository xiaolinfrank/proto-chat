...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Pre-set plan ID for the next billing cycle (for mid-cycle downgrades or cancellations)
        ...
        // ============ Downgrade Info ============
        // Downgrade reason: deduct_failed (payment deduction failed), user_unsign (user terminated agreement), expired (subscription expired without renewal)
