...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // References main project users.id
        ...
        // Preset plan ID for the next billing period (used for mid-cycle downgrade or subscription cancellation)
        ...
        // Downgrade reason: deduct_failed (deduction failed), user_unsign (user cancelled), expired (expired without renewal)
