...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Foreign key to main project users table (users.id)
        ...
        // ============ Downgrade Info ============
        // Downgrade reason: deduct_failed (payment failed), user_unsign (user cancelled), expired (not renewed after expiry)
...
export const userSubscriptionHistory = pgTable('user_subscription_history', {
    ...
    // Foreign key to main project user ID
