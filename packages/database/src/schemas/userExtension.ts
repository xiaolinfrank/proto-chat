...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Preset plan ID for next billing period (used for mid-cycle downgrade or cancellation)
        ...
        // Downgrade reason: deduct_failed (payment failure), user_unsign (user termination), expired (subscription expired)
