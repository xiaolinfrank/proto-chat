...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Downgrade reason: deduct_failed (deduction failed), user_unsign (user cancellation), expired (expired without renewal)
...
export const userSubscriptionHistory = pgTable('user_subscription_history', {
    ...
    // Status: active, canceled, expired, past_due, upgraded
