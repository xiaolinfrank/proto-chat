...
export const userExtensions = pgTable(
    'user_extensions',
    {
        ...
        // Associated main project users table users.id
        ...
        // Next billing cycle preset plan ID (used for mid-cycle downgrade or cancellation)
        ...
        // Downgrade reason: deduct_failed(deduction failed), user_unsign(user terminated agreement), expired(subscription expired)
