 ...
 * Stores embedding model information synchronized from providers, for selection only
 */
...
export const embeddingUsageLogs = pgTable(
  'embedding_usage_logs',
  {
    ...
    // Fee records (using scale: 8 to support very small cost values, e.g. $0.00000001)
