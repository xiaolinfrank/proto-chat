 ...
 * Stores the global embedding model configuration
 */
...
/**
 * Embedding available model list
...
export const embeddingUsageLogs = pgTable(
  'embedding_usage_logs',
  {
    ...
    fileId: text('file_id'), // If this is a file embedding (references files.id - text type)
