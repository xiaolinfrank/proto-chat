 ...
 * Stores embedding model information synced from providers, used for selection only
 */
 ...
 * Records detailed logs of user embedding usage, used for cost analysis and auditing
 */
