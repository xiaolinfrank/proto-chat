 ...
 * Stores global embedding model configuration
 */
 ...
 * Records detailed usage logs for cost analysis and auditing
 */
export const embeddingUsageLogs = pgTable(
  'embedding_usage_logs',
  {
    ...
    fileId: text('file_id'), // If file embedding (corresponding to files.id - text type)
