 ...
 * Stores embedding model info synced from providers, for selection purposes only
 */
...
export const embeddingUsageLogs = pgTable(
  'embedding_usage_logs',
  {
    ...
    // Cost record (uses scale: 8 to support very small cost values, e.g. $0.00000001)
