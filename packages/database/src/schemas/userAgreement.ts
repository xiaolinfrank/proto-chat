...
export const userAgreements = pgTable('user_agreements', {
  ...
  // Merchant agreement number (generated by us, uniquely identifies the user agreement)
  ...
  // Cancellation reason: user_unsign (user cancelled), merchant_unsign (merchant cancelled), expired (expired)
