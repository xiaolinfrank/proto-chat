...
/**
 * User agreement table - Manages Alipay/WeChat periodic payment agreement information
 */
export const userAgreements = pgTable('user_agreements', {
  ...
  // ============ Agreement Status ============
  // pending: pending signature, signed: signed, unsigned: unsigned
  status: varchar('status', { length: 20 }).default('pending').notNull(),
  // Signing time
  signTime: timestamp('sign_time'),
  // Unsigning time
  unsignTime: timestamp('unsign_time'),
  // Unsigning reason: user_unsign (user initiated), merchant_unsign (merchant initiated), expired (expired)
  ...
  // Daily deduction failure count (for retry logic)
  ...
  // First payment order number at signing
