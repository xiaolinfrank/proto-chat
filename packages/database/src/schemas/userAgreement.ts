...
/**
 * User agreement table - manages Alipay/WeChat recurring deduction agreement information
 */
export const userAgreements = pgTable('user_agreements', {
  ...
  // Agreement scene, e.g. INDUSTRY|DIGITAL_MEDIA
  signScene: varchar('sign_scene', { length: 64 }).notNull(),
  // Agreement channel: alipay | wechat
  ...
  // ============ Agreement Status ============
  // pending: awaiting agreement, signed: agreement active, unsigned: agreement cancelled
  status: varchar('status', { length: 20 }).default('pending').notNull(),
  // Agreement sign time
  signTime: timestamp('sign_time'),
  // Agreement cancellation time
  unsignTime: timestamp('unsign_time'),
  // Cancellation reason: user_unsign (user initiated), merchant_unsign (merchant initiated), expired (expired)
  ...
  // Number of deduction failures on the current day (used for retry logic)
  ...
  // ============ Extended Info ============
  // First payment order number at the time of agreement signing
