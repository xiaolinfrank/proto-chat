...
export const userAgreements = pgTable('user_agreements', {
  ...
  // ============ Agreement Status ============
  // pending: awaiting signing, signed: signed, unsigned: cancelled
  status: varchar('status', { length: 20 }).default('pending').notNull(),
  // Signing time
  signTime: timestamp('sign_time'),
  // Cancellation time
  unsignTime: timestamp('unsign_time'),
  // Cancellation reason: user_unsign (user-initiated cancellation), merchant_unsign (merchant cancellation), expired (expiry)
  ...
  // First payment order number at the time of signing
