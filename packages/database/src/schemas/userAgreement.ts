...
/**
 * User agreement table - manages Alipay/WeChat recurring deduction agreement info
 */
export const userAgreements = pgTable('user_agreements', {
  ...
  // Cancellation reason: user_unsign (user-initiated), merchant_unsign (merchant-initiated), expired (lapsed)
