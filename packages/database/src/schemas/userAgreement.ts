...
/**
 * User Agreement Table - Manages Alipay/WeChat recurring payment subscription information
 */
export const userAgreements = pgTable('user_agreements', {
  ...
  // Merchant agreement number (generated by us, uniquely identifies user subscription)
  ...
  // ============ Agreement Status ============
  // pending: awaiting signature, signed: signed, unsigned: unsigned
  status: varchar('status', { length: 20 }).default('pending').notNull(),
  // Signing time
  signTime: timestamp('sign_time'),
  // Unsigned time
  unsignTime: timestamp('unsign_time'),
  // Unsigned reason: user_unsign (user-initiated), merchant_unsign (merchant-initiated), expired
