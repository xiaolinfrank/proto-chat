...
export const userAgreements = pgTable('user_agreements', {
  ...
  // ============ Agreement Status ============
  // pending: awaiting agreement, signed: agreement signed, unsigned: agreement canceled
  status: varchar('status', { length: 20 }).default('pending').notNull(),
  // Agreement sign time
  signTime: timestamp('sign_time'),
  // Agreement cancel time
  unsignTime: timestamp('unsign_time'),
  // Cancellation reason: user_unsign (user canceled), merchant_unsign (merchant canceled), expired (expired)
