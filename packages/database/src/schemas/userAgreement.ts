...
export const userAgreements = pgTable('user_agreements', {
  ...
  // Merchant agreement number (generated by us, uniquely identifies user agreements)
  ...
  // Termination reason: user_unsign (user-initiated cancellation), merchant_unsign (merchant cancellation), expired (expiration)
