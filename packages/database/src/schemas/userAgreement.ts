...
/**
 * User agreement table - manages Alipay/WeChat recurring debit agreement information
 */
export const userAgreements = pgTable('user_agreements', {
  ...
  // ============ Agreement status ============
  // pending: awaiting agreement, signed: agreed, unsigned: cancelled
  status: varchar('status', { length: 20 }).default('pending').notNull(),
  // Agreement sign time
  signTime: timestamp('sign_time'),
  // Agreement cancellation time
  unsignTime: timestamp('unsign_time'),
  // Cancellation reason: user_unsign (user-initiated cancellation), merchant_unsign (merchant cancellation), expired (expired)
