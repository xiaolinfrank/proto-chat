...
/**
 * User agreement table - manages Alipay/WeChat recurring deduction contract info
 */
export const userAgreements = pgTable('user_agreements', {
  ...
  // ============ Contract Status ============
  // pending: awaiting contract, signed: contracted, unsigned: cancelled
  ...
  // ============ Extended Info ============
  // First payment order number at contract signing
