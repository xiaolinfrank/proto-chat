...
export const userAgreements = pgTable('user_agreements', {
  ...
  // Termination reason: user_unsign (user terminated), merchant_unsign (merchant terminated), expired (expired)
  ...
  // Number of failed deductions for the day (used for retry logic)
