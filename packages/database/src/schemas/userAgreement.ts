...
export const userAgreements = pgTable('user_agreements', {
  ...
  // ============ Agreement Status ============
  // pending: awaiting sign, signed: agreement active, unsigned: agreement cancelled
  status: varchar('status', { length: 20 }).default('pending').notNull(),
  // Sign time
  signTime: timestamp('sign_time'),
  // Unsign time
  unsignTime: timestamp('unsign_time'),
  // Unsign reason: user_unsign (user-initiated), merchant_unsign (merchant unsign), expired (expired)
