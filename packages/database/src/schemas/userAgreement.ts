...
/**
 * User agreement table - manages Alipay/WeChat recurring deduction sign-up information
 */
export const userAgreements = pgTable('user_agreements', {
  ...
  // Merchant agreement number (generated by us, uniquely identifies a user's sign-up)
  ...
  // ============ Agreement Status ============
  // pending: awaiting sign-up, signed: signed, unsigned: cancelled
  ...
  // Number of failed deductions on the same day (used for retry logic)
  ...
  // First payment order number at the time of sign-up
